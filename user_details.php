  ...
  <body>
    ...
    ?>
      ...
      <section class="bg-light text-dark p-4 text-center text-sm-start">
        ...
        <form class="" action="user_details2.php" enctype="multipart/form-data"
        method="post">
          ...
          <div class="row mb-4">
            <div class="col">
              <div class="form-outline">
                <input type="text" id="form6Example1" name="fname" class="form-control" value="<?php echo $row['userfirstname']; ?>" required/>
                <label class="form-label" for="form6Example1">First name</label>
              </div>
            </div>
            <div class="col">
              <div class="form-outline">
                <input type="text" id="form6Example2" name="lname" class="form-control" value="<?php echo $row['userlastname']; ?>" required/>
          ...
          <div class="input-group mb-3 mt-4">
            ...
            <img src="userpics/<?php echo $row['userpicture']; ?>"
            class="img col-2"  alt="">
          </div>
