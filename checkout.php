                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul class="checkout__total__products">
                                    <li>01. Piqué Biker Jacket <span>LKR: 4500.00</span></li>
                                    <li>02. Flat Shoes <span>LKR: 3500.00</span></li>
                                    <li>03. Basic Flowing Scalf <span>LKR: 500.00</span></li>
                                    <li>04. Leather Backpack <span>LKR: 3000.00</span></li>
                                </ul>
                                <ul class="checkout__total__all">
                                    <li>Subtotal <span>LKR: 8800.00</span></li>
                                    <li>Total <span>LKR: 8800.00</span></li>
                                </ul>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="checkout.php">Delivary</a></li>
                        </ul>
                    </div>
                </div>
