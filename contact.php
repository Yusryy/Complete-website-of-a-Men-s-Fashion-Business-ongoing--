...
<body>
    ...
    <!-- Map Begin -->
    <div class="map">
        <iframe src="https://www.google.com/maps/d/embed?mid=15d7WBWfQVhViaR0cAzGa3vSzia2TBCw&ehbc=2E312F" height="500" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
    <!-- Map End -->
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__text">
                        ...
                        <ul>
                            <li>
                                <h4>Colombo</h4>
                                <p>32/B, Main Street, Maradana<br />0118231409</p>
                            </li>
                            <li>
                                <h4>Kandy</h4>
                                <p>211/A, Peradeniya Road, Kandy <br />0812309893</p>
                            </li>
                            <li>
                                <h4>Matale</h4>
                                <p>251, Kandy Road, Matale <br />0662847993</p>
                            </li>
                            <li>
                                <h4>Kurunegala</h4>
                                <p>541, Main Street, Kurunegala <br />0378493647</p>
                            </li>
                            <li>
                                <h4>Galle</h4>
                                <p>256, Colombo Road, Galle <br />0917563839</p>
                            </li>
                            <li>
                                <h4>Mawanella</h4>
                                <p>251, Colombo Road, Mawanella <br />0358567125</p>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="contact__form">
                        <form action="message.php">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <input type="email" placeholder="email" name="emailid" value="" required>
                                </div>
                                <div class="col-lg-12">
