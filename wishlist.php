...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php
        ...
        $sql = "select pro_id from wish where user_id=$user_id";
        ?>
      ...
      <section class="bg-light text-dark p-4 text-center text-sm-start">
        ...
        <div class="container py-3">
          <h3><span class="py-5" style="color:#033B5B;"> Wish List  </span></h3>
      ...
      <section>
        ...
        <?php
          ...
          if(mysqli_num_rows($rs)>0){
            while($row = mysqli_fetch_assoc($rs)){
              $productarray = getProductDetails($row['pro_id'])
        ?>
        <div class="col-sm-6">
        <div class="card mb-3" style="min-height:235px;">
        ...
        <div class="col-md-6">
          <div class="card-body" >
            ...
            <a href="wish_del.php?value=<?php echo $productarray[0] ?>"><button class="btn btn-dark btn-sm" type="button" name="button">Unwish</button></a>
      ...
      <?php
        $sql = "select * from userdetails where user_id=$user_id";
        ...
        <div class="offcanvas-body">
          <div class="row ">
            <div class="d-flex justify-content-center" id="profimg">
              <img src="userpics/<?php echo $row['userpicture'];?>"  style="border-radius: 50%" width="100" height="100" alt="">
            </div>
          </div>
          <div class="row">
            <div class="d-flex justify-content-center mt-3">
              <p style="font-size: 18px;"><?php echo $row['userfirstname'];?> <?php echo $row['userlastname'];?></p>
            </div>
            <div class="row">
          ...
          <div class="list-group list-group-flush m-0 p-0">
            <a href="wishlist.php" class="list-group-item list-group-item-action list-group-item-light"><p class="m-1 p-0">&nbsp;&nbsp;<i class="fas fa-hand-holding-heart"></i> &nbsp;&nbsp; Wish List</p></a>
            ...
            <a href="sign-out0.php" style="position:absolute; display:inline-block; bottom:0; right:1px;" class="list-group-item list-group-item-action list-group-item-light"><p class="pt-2">&nbsp;&nbsp;<i class="fas fa-sign-out-alt"></i>&nbsp;&nbsp; Sign Out</p></a>
          </div >
         </div>
      </div>
      <?php
